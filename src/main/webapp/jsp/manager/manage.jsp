    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link active" href="<%=request.getContextPath() + "/manager/manage"%> "><fmt:message
                        key="Manage" bundle="${rb}"/></a>
...
<div class="container">
    <div class="row ">
        ...
        <form action="<%=request.getContextPath() + "/manager/manage/changeRole"%>" method="post">
            ...
            <input required id="userId" type="number" list="userIdList" name="userId" class="form-select"
                   list="userIdList" placeholder="ID">
            ...
            <br>
            <div align="center"><input type="submit" value="<fmt:message key="Change_user_role" bundle="${rb}"/>"
